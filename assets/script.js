...
const IniciarQuiz = document.getElementById("IniciaQuiz");
const btnIniciar = document.getElementById("iniciar");
const LocalPergunta = document.getElementById("LocalPergunta");
...
function quiz(){
    ...
    if (PerguntaAtual < perguntas.length){
        ...
        LocalPergunta.style.display = "flex";
        pergunta.textContent = PerguntaAtual+1 + ") " + perguntas[PerguntaAtual].question;
    }
    if(perguntas.VF == false){
        perguntas[PerguntaAtual].answers.forEach(answer => {
